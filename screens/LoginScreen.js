        ...
        <View style={[styles.container, { backgroundColor: theme.colors.background }]}>
            ...
            <View style={styles.innerContainer}>
                ...
                <View style={styles.phoneInputContainer}>
                    ...
                    <TextInput keyboardType="numeric" value={phoneNumber} onChange={value => setPhoneNumber(value)} placeholder="Enter phone number" style={[styles.phoneInput, { fontFamily: theme.fontfamily.regular, fontSize: theme.fontsize.medium }]} />
                </View>
